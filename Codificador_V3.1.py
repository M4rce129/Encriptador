...
MANUAL_URL = "https://encriptador-wep.vercel.app/" 
GITHUP_URL = "https://github.com/M4rce129/Encriptador"
...
def OpenGithub():
    if GITHUP_URL:
        print("\033[36m>> Abriendo GitHub...\033[32m")
        wait(1)
        os.system(f"start {GITHUP_URL}")  # * Abre el enlace en el navegador predeterminado
        print("\033[36m>> GitHub abierto\033[32m")
        print()
    else:
...
def Help():
    ...
    print("GIT => Abrir el repositorio en GitHub")
    print("\033[2m-Entra el comando\033[36m MANUAL\033[0m \033[32m y revisa el tutorial-\033[0m")
